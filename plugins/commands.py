...
HOME_TEXT = "<b>Hey  [{}](tg://user?id={}) 🙋‍♂️\n\nsaya bot yang dibangun untuk diputar atau streaming video di telegram voicechats. \n saya dapat streaming video youtube atau file telegram atau bahkan live youtube.</b>"
...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/about_db'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/DazRepo')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/DazRepo'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/about_db'),     
        ],
        [
